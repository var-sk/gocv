...
DLL_EXPORT void Demosaicing(Mat src, Mat dst, int code);
...
DLL_EXPORT float EMD(Mat sig1, Mat sig2, int distType);
...
DLL_EXPORT void CreateHanningWindow(Mat dst, Size size, int typ);
